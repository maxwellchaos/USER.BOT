...
namespace USER.BOT
{
    public partial class formgdz : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            reqeuest2 = "https://api.vk.com/method/docs.get?owner_id=-199265164&type=4&access_token=7a695e3b21b5632316f71ca64ea5680d3bb3083eff4cbab89c826c6b44363b39640c974c3712a1228733e&v=5.124";
            answer2 = Encoding.UTF8.GetString(cl.DownloadData(reqeuest2));
            docsget dc = JsonConvert.DeserializeObject<docsget>(answer2);
            
            if(dc.response.items[0].title.Contains("00_00_00_0000_"))
            {
                //нашли нужный файл
